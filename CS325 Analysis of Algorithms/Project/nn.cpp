...
float nearestNeighbor(vector< vector<int> > &G, vector<int> &r); 
...
int main(int argc, char *argv[]) {	
	...
	float pathLength;             //The total length of the salesman's path
	int i; 
...
*******************************************************************************************************/
float nearestNeighbor(vector< vector<int> > &G, vector<int> &r) {
	vector<int> currentVertex = G[0];          //Choose starting vertex
	bool allVisited = false;                   //Initially all verticies haven't been visited  
	float shortestPath,                        //Holds the current shortest path
	distance,                                  //Distance to the next vertex
	length = 0;                                //Initialize overall path length to 0
	int i, nn;                                 //nn is the index of the nearest neighbor
