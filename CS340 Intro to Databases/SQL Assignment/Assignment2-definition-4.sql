...
((SELECT `id` FROM `client` WHERE `first_name` = 'Daniel' AND `last_name` = 'Jenson'), 'Moon', NULL);
...
VALUES ((SELECT `id` FROM `employee` WHERE `first_name` = 'Adam' AND `last_name` = 'Lowd'),(SELECT `id` FROM `project` WHERE `name` = 'Diamond'),'2012-01-01'), 
((SELECT `id` FROM `employee` WHERE `first_name` = 'Michael' AND `last_name` = 'Fern'),(SELECT `id` FROM `project` WHERE `name` = 'Eclipse'),'2013-08-08'), 
((SELECT `id` FROM `employee` WHERE `first_name` = 'Michael' AND `last_name` = 'Fern'),(SELECT `id` FROM `project` WHERE `name` = 'Moon'),'2014-09-011');
